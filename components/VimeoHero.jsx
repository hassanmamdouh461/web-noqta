...
export default function VimeoHero() {
    ...
    /* ── Hover mute bubble — GSAP elastic spring ── */
    useEffect(() => {
        ...
        <>
            ...
            >
                ...
                <video
                    ...
                    style={{ objectFit: 'cover', backgroundColor: '#0c0e12', opacity: 0.65 }}
                />

                {/* Animated gradient mesh behind / over video */}
                <div style={{
                    position: 'absolute',
                    inset: 0,
                    background: 'radial-gradient(ellipse 70% 60% at 30% 40%, rgba(75, 105, 240, 0.25), transparent 70%), radial-gradient(ellipse 60% 50% at 80% 60%, rgba(245, 105, 60, 0.2), transparent 60%), linear-gradient(180deg, rgba(10, 10, 14, 0.4) 0%, rgba(10, 10, 14, 0.95) 100%)',
                    pointerEvents: 'none'
                }} />
                ...
                <div className="home-header__title">
                    <div style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', marginBottom: '12px', background: 'rgba(255,255,255,0.1)', padding: '6px 14px', borderRadius: '30px', backdropFilter: 'blur(10px)' }}>
                        <span style={{ width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#f5693c' }}></span>
                        <span style={{ fontSize: '13px', fontWeight: 700, letterSpacing: '0.1em', textTransform: 'uppercase', color: '#fff' }}>
                            نقطة • SOFTWARE & CREATIVE MEDIA
                        </span>
                    </div>
                    ...
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        <span className="vimeo-hero__word"><em>code &amp; media </em></span>
                        <span className="vimeo-hero__word">for </span>

                        <div style={{ flexBasis: '100%', height: 0 }} />

                        <span className="vimeo-hero__word">the </span>
                        <span className="vimeo-hero__word">next </span>

                        {/* "generation" + star + oval underline */}
                        <span className="vimeo-hero__word is--relative">
                    ...
                    <button className="vimeo-hero__btn" onClick={togglePlay} aria-label={isPlaying ? 'Pause' : 'Play'}>
                        {isPlaying ? (
                            <svg viewBox="0 0 24 24" fill="none">
                                ...
                                <path d="M15.5 5.125H18.5C18.7071 5.125 18.875 5.29289 18.875 5.5V18.5C18.875 18.7071 18.875 18.875 18.5 18.875H15.5C15.2929 18.875 15.125 18.7071 15.125 18.5V5.5C15.125 5.29289 15.2929 5.125 15.5 5.125Z" stroke="currentColor" strokeWidth="1.25" strokeMiterlimit="10" />
                            </svg>
                        ) : (
                            <svg viewBox="0 0 24 24" fill="none">
